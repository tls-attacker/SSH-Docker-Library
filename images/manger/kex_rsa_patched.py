...
class _KexRSA(Kex):
    ...
    def start(self):
        ...
        if self._conn.is_server():
            ...
            self._trans_key = vulnerability.get_static_transient_public_key(self._key_size)
    ...
    def _process_secret(self, _pkttype, _pktid, packet):
        ...
        if not vulnerability.first_byte_is_zero(self._trans_key, self._encrypted_k):
            raise KeyExchangeFailed('Key exchange decryption failed because first byte is not 00')
