...
public class ParameterProfileSerializerTest {
    ...
    public void testWrite() throws Exception {
        ...
        ParameterProfile profile = new ParameterProfile("openssl_default", "Default Profile for OpenSSH",
            SshImplementationType.OPENSSH, ConnectionRole.CLIENT, versionList, parameterList);
